...
# ggplot(confirmed_cases_worldwide, aes(x=date, y=cum_cases)) + geom_line() +
# # Label the y-axis "Cumulative confirmed cases"
# ylab("Cumultive confirmed cases") +
# # Label the x-axis
# xlab("Date");
...
#   geom_line(aes(date, cum_cases), colour = "green") +
#   ylab("Cumulative confirmed cases")

# # See the plot
# print(plt_cum_confirmed_cases_china_vs_world)
